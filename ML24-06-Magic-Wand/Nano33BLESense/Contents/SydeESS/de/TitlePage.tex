...
\begin{titlepage}
	...
	{\hspace{-50mm}%\vspace{-30mm}
		\begin{tikzpicture}
			...
			\node[white,right] (Title) at (3,1) {\Huge \textsf{\TRANS{Künstliche Intelligenz mit dem ESP32CAM}{Artificial Intelligence with an ESP32CAM}}};
			\node[white,right] (Title) at (3,0) {\LARGE \textsf{\TRANS{Identifizierung von Barcodes}{Barcode Identification}}};
