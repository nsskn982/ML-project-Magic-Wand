...
\DeclareAcronym{mems}{
	short = MEMS\index{MEMS}, 
	long  = Microelectromechanical Systems\index{Microelectromechanical Systems!\Siehe {MEMS}},
}
...
\DeclareAcronym{tpu}{
	short = TPU\index{TPU}, 
	long  = Tensor Processing Un
    it\index{Tensor Processing Unit!\Siehe TPU},
}
\DeclareAcronym{tinyml}{
	short = TinyML\index{TinyML} ,
	long  = Tiny Machine Learning\index{Tiny Machine Learning!\Siehe TinyML},
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% U
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
